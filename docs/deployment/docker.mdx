...
For local development and testing, you can run Bellerophone AI directly on your machine using Docker with a single command.

### Quick Start

Run this single command to download and start Bellerophone AI:
