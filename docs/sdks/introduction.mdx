---
title: "Introduction"
description: "Build and operate Bellerophone voice AI agents programmatically from Python or TypeScript"
---

Bellerophone ships official SDKs for **Python** and **TypeScript** that wrap the Bellerophone REST API and the workflow builder. Use them to create or edit agents, place outbound calls, and inspect runs from your own code.
