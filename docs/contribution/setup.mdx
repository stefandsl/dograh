---
title: Setup
description: Set up the Bellerophone contributor environment with the devcontainer-first workflow.
---
<Note>
...
1. Fork the Bellerophone repository at https://github.com/dograh-hq/dograh
2. Clone **your fork**:
```bash
