...
| Field | Description |
| --- | --- |
| **Endpoint URL** | The URL Bellerophone will send the POST request to. |
...
Bellerophone sends a `POST` request with the following JSON payload:
