...
description: "Connect Bellerophone AI with external services and platforms"
---

## Introduction

Bellerophone AI provides a flexible integration architecture that allows you to connect with various external services and platforms. Our integration system is designed with modularity and extensibility in mind, making it easy to add new providers while maintaining backward compatibility.
