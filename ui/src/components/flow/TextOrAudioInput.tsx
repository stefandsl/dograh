...
export function StaticTextWarning() {
    const t = useTranslations("components.flow.textOrAudioInput");
    return (
        ...
        <>
            ...
            >
                <div className="flex items-center gap-2">
                    ...
                    <Label htmlFor="toa-text" className="font-normal cursor-pointer">{t("text")}</Label>
                </div>
                <div className="flex items-center gap-2">
                    <RadioGroupItem value="audio" id="toa-audio" />
                    <Label htmlFor="toa-audio" className="font-normal cursor-pointer">{t("audio")}</Label>
                </div>
            </RadioGroup>
            {type === 'text' ? (
                children
                ...
                <PopoverTrigger asChild>
                    ...
                    >
                        {selected ? (
                            ...
                            <span className="text-muted-foreground">{t("selectRecording")}</span>
                        )}
                ...
                >
                    {recordings.length === 0 ? (
                        ...
                        <div>
                            ...
                            {filtered.length === 0 ? (
                                <div className="p-3 text-sm text-muted-foreground text-center">
                                    {t("noRecordingsMatch", { query: search })}
                                </div>
                            ) : filtered.map((r) => {
