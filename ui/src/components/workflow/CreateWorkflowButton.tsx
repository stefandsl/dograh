...
export function CreateWorkflowButton() {
    const t = useTranslations("components.workflow.createWorkflowButton");
    ...
    const handleBlankCanvas = async () => {
        ...
        try {
            ...
            toast.error(t('createWorkflowError'));
        } finally {
            setIsCreating(false);
        }
    };
            ...
            <DropdownMenuContent align="end">
                <DropdownMenuItem onClick={handleAgentBuilder} className="cursor-pointer">
                    ...
                    <div>
                        ...
                        <div className="text-xs text-muted-foreground">{t('useAgentBuilderDescription')}</div>
                    </div>
                </DropdownMenuItem>
                <DropdownMenuItem onClick={handleBlankCanvas} disabled={isCreating} className="cursor-pointer">
                    ...
                    <div>
                        ...
                        <div className="text-xs text-muted-foreground">{t('blankCanvasDescription')}</div>
                    </div>
                </DropdownMenuItem>
            </DropdownMenuContent>
        </DropdownMenu>
